...
const { login, register, getAllUser, getUserById, updateUser, deleteUserById, updateUserFreeCourse, getProfile, logout, changePassword, updateAvatar, forgotPassword, resetPassword } = require('../controllers/authenController');
const { verifyAdmin, verifyUser, verifyToken, verifyToken2 } = require('../utils/verifyToken');
