...
const { login, register, getAllUser, getUserById, updateUser, deleteUserById, updateUserFreeCourse, getProfile, logout, changePassword } = require('../controllers/authenController');
...
authRoute.put("/profile/:id", updateUser);
