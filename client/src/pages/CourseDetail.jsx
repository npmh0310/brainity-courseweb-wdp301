...
function CourseDetail() {
  ...
  const filteredRatings = rating.filter((r) => r.comment);
  useEffect(() => {
  ...
  return (
    <div className="relative courseDetail w-full ">
      <div
        style={{ height: `${heightOfBanner}px` }}
        className={`absolute bg-[#2d2f31]  z-0 w-full`}
      ></div>
      <GlobalLoading />
      {course && (
        <>
          ...
          >
            <div className=" w-full px-2 lg:w-8/12 z-10 ">
              ...
              >
                ...
                <div className=" text-white text-sm tracking-wide">
                  Create by{" "}
                  <a className=" text-purple-200 underline" href="#">
                    NgocTam
                  </a>
                </div>
              </div>
            ...
            <div className=" relative w-0 lg:w-4/12">
              <div
                className={`courseView  hidden lg:flex mt-6  ml-4 min-w-[320px] w-[320px] bg-white shadow-lg ${
                  isScrolled ? "  sticky top-0 animate-open pt-[85px]" : ""
                }`}
              >
