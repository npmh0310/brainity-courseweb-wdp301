                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                {imgUrl && <img src={imgUrl} alt="" className=' py-2 w-full max-h-[450px] object-cover' />} 
                                <input
                                    type="file"
                                    className=''
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="mt-2 flex gap-x-2">
                                {selectedOption && selectedOption.map((categorie, index) => (<p>/ {categorie.label} </p>))}
                            </div>
                        </div>

                        <div className="sm:col-span-2">
                                {imgUrl && <img src={imgUrl} alt="" className=' w-full max-h-[450px] object-cover' />} 
                        </div>
                        {/* Description */}
                        <div className="sm:col-span-2">
